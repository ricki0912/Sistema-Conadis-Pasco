...
public class DirectorEstablecimiento {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DirectorEstablecimiento other = (DirectorEstablecimiento) obj;
		if (id != other.id)
			return false;
		return true;
	}
	...
	public DirectorEstablecimiento(int nro, int id, String dni, String cmp, String rne, String nombres_apellido,
