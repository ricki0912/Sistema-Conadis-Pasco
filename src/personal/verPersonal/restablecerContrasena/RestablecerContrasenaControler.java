package personal.verPersonal.restablecerContrasena;
...
public class RestablecerContrasenaControler extends Funciones  implements Initializable {
	...
	public TextField getTextFieldDniUsuario() {
		return textFieldDniUsuario;
	}
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		buttonGuardar.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				if(textFieldDniUsuario.getText().isEmpty()){
					labelInformacion.setText("Por favor seleccione un Usuario");
				}else{
					if(passwordFieldNuevaContrasena.getText().trim().isEmpty()||passwordFieldRepetirNuevaContrasena.getText().trim().isEmpty()){
						...
						if(passwordFieldNuevaContrasena.getText().equals(passwordFieldRepetirNuevaContrasena.getText())){
							labelInformacion.setText(actualizarContrasena(encriptar(passwordFieldNuevaContrasena.getText()),textFieldDniUsuario.getText()));
...
public String actualizarContrasena(String nuevaContrasenaEncriptada, String DNI){
