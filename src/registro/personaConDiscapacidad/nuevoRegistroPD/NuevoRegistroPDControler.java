	...
	*/
	...
	public void insertarDatosPersonaDiscapacidad_v1(){
		...
		try{
			...
			pstPerDiscapacidad=conn.prepareStatement("INSERT INTO PER_DISCAPACIDAD(NOMBRES, APELL_PATERNO,APELL_MATERNO,DNI,CUI,FECHA_NACIMIENTO,SEXO,ID_NIVEL_EDUCATIVO,ID_TIPO_TRABAJO,ID_DOMICILIO,CREADO_POR,MODIFICADO_POR, "
					+ "ID_ESTADO_CIVIL,EMAIL, NUM_CONTACTO,OBSERVACION, UTLIMO_AÑO_NIVEL_EDUCATIVO,OCUPACION_DESEMPENNA, ID_CLASIFICACION_SISFOH) "
					+ "		   VALUES(?, ?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);", PreparedStatement.RETURN_GENERATED_KEYS);
			...
			labelInformacion.setText("Datos de Tiene Conocimiento En.. Inserción Correcta...");	
			...
			labelInformacion.setText("Datos de Necesita Aprender.. Inserción Correcta...");	
